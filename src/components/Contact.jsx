...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    setLoading(true);
    emailjs.send('service_yc8rh71','template_w4aarur', {from_name:form.name, to_name:'Zaid', from_email:form.email,to_email:'loveyours0214@gmail.com',message:form.message},'iVe3KTYHvtE4dZ3BT').then(()=>{
      setLoading(false);
